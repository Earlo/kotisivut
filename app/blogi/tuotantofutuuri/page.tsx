  ...
  return (
    <div className="max-w-8xl mx-auto bg-gray-950 p-4">
      ...
      <Text>
        ...
        asettaessa, huomattiin että Suomen ruoantuotanto oli hyvinkin riippuvainen Venäjästä, esim. lannoitteen suhteen.
      </Text>
      <Text>
      ...
      <Text>
        ...
        kriisiolosuhteissa jotta väestön selviäminen voidaan taata. Sanotaan että laskelmat tehdään, ja yksi komponentti
        tässä on vaikka että Suomen väestö tarvitsee selvitäkseen sata tonnia herneitä.
      </Text>
      <Text>
      ...
      <Text>
        Kun aikaa kuluu, toimitusajankohta lähestyy, ja käy selväksi että herneille ei olekaan tarvetta väestönsuojissa,
        niin nämä hernefutuurit voitaisiin asettaa myyntiin avoimille markkinoille. Oletettavasti huoltovarmuuskeskus ei
        saisi näistä herneistä aivan niin hyvää hintaa kuin oli itse maksanut, sillä normaaleilla markkinoilla ei
        niinkään ole kiinnostusta siihen, onko tuotannossa käytetty kotimaista lannoitetta vai ei, mutta tietty
        markkina-arvo herneillä toki on. Jollain korvauksella valtio pääsisi siis eroon hernevuoresta, markkinoille
        virtaisi kotimaisia herneitä, ja futuurin osto- ja myyntihinnan välinen erotus määrittäisi sen miten paljon
        maataloustoimintaa suomessa on tarvetta tukea.
      </Text>
      <Text>

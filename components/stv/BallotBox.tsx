...
const BallotBox: React.FC<BallotBoxProps> = ({ votes, setVotes, candidates }) => {
  return (
    <div className="mx-auto w-full rounded-lg bg-gray-700 p-4 shadow-lg">
      <h2 className="mb-6 text-center text-2xl font-bold text-white">Äänilipas (Ääniä: {votes.length} kpl)</h2>
